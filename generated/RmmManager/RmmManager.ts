...
export class RmmManager__marginsResult {
  value0: BigInt;
  value1: BigInt;
...
export class RmmManager__removeResult {
  value0: BigInt;
  value1: BigInt;
...
export class RmmManager extends ethereum.SmartContract {
  static bind(address: Address): RmmManager {
    return new RmmManager("RmmManager", address);
  }
  ...
  margins(param0: Address, param1: Address): RmmManager__marginsResult {
    let result = super.call(
      "margins",
    ...
    return new RmmManager__marginsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_margins(
    param0: Address,
    param1: Address
  ): ethereum.CallResult<RmmManager__marginsResult> {
    let result = super.tryCall(
      "margins",
      "margins(address,address):(uint128,uint128)",
      [ethereum.Value.fromAddress(param0), ethereum.Value.fromAddress(param1)]
    ...
    return ethereum.CallResult.fromValue(
      new RmmManager__marginsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  remove(
    ...
    return new RmmManager__removeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_remove(
    ...
    minRiskyOut: BigInt,
    minStableOut: BigInt
  ): ethereum.CallResult<RmmManager__removeResult> {
    let result = super.tryCall(
      "remove",
      "remove(address,bytes32,uint256,uint256,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RmmManager__removeResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
