...
export class PrimitiveEngine__calibrationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PrimitiveEngine__createResult {
  value0: Bytes;
  value1: BigInt;
  value2: BigInt;
...
export class PrimitiveEngine__marginsResult {
  value0: BigInt;
  value1: BigInt;
...
export class PrimitiveEngine__removeResult {
  value0: BigInt;
  value1: BigInt;
...
export class PrimitiveEngine__reservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PrimitiveEngine extends ethereum.SmartContract {
  static bind(address: Address): PrimitiveEngine {
    return new PrimitiveEngine("PrimitiveEngine", address);
  }
  ...
  calibrations(param0: Bytes): PrimitiveEngine__calibrationsResult {
    let result = super.call(
      "calibrations",
    ...
    return new PrimitiveEngine__calibrationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_calibrations(
    param0: Bytes
  ): ethereum.CallResult<PrimitiveEngine__calibrationsResult> {
    let result = super.tryCall(
      "calibrations",
      "calibrations(bytes32):(uint128,uint32,uint32,uint32,uint32)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new PrimitiveEngine__calibrationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  create(
    ...
    return new PrimitiveEngine__createResult(
      result[0].toBytes(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_create(
    ...
    delLiquidity: BigInt,
    data: Bytes
  ): ethereum.CallResult<PrimitiveEngine__createResult> {
    let result = super.tryCall(
      "create",
      "create(uint128,uint32,uint32,uint32,uint256,uint256,bytes):(bytes32,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PrimitiveEngine__createResult(
        value[0].toBytes(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  try_margins(
    param0: Address
  ): ethereum.CallResult<PrimitiveEngine__marginsResult> {
    let result = super.tryCall(
      "margins",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PrimitiveEngine__marginsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  remove(poolId: Bytes, delLiquidity: BigInt): PrimitiveEngine__removeResult {
    let result = super.call(
      "remove",
    ...
    return new PrimitiveEngine__removeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_remove(
    poolId: Bytes,
    delLiquidity: BigInt
  ): ethereum.CallResult<PrimitiveEngine__removeResult> {
    let result = super.tryCall(
      "remove",
      "remove(bytes32,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PrimitiveEngine__removeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  reserves(param0: Bytes): PrimitiveEngine__reservesResult {
    let result = super.call(
      "reserves",
    ...
    return new PrimitiveEngine__reservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_reserves(
    param0: Bytes
  ): ethereum.CallResult<PrimitiveEngine__reservesResult> {
    let result = super.tryCall(
      "reserves",
      "reserves(bytes32):(uint128,uint128,uint128,uint32,uint256,uint256,uint256)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PrimitiveEngine__reservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
